...
@section('content')
    <section class="container">
        <div class="lg:flex items-center justify-between pt-14 pb-8 text-center lg:text-left">
			...
			<p class="category-desc mb-5">“NOTHING CAN BEAT WARMING UP TO A WHOLESOME BOWL OF GOODNESS. ALL OUR SOUPS ARE MADE FROM SCRATCH, WITH THE FINEST INGREDIENTS.</p>
