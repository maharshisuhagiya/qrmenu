        ...
        <table class="table align-middle datatable dt-responsive table-check nowrap dataTable no-footer  table-bordered" '' id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
            <thead>
                <tr role="row">
                    ...
                    <th scope="col">
                        <div class="d-flex justify-content-between w-200px">
                    ...
                    <th scope="col">
                        <div class="d-flex justify-content-between w-130px">
            ...
            <tbody>
                ...
                @forelse ($restaurants ?? [] as $restaurant)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('restaurant.menu', ['restaurant' => $restaurant->id]) }}" target="_blank">
