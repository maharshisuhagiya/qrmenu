                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-md-6">
                                <form autocomplete="off" action="" id='QRData' enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="nav flex-column nav-pills bg-light-gray" id="v-pills-tab"
                                            ...
                                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <button type="button"
                                                                class="btn btn-danger remove-image preview-image d-sm-block"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-3">
                                            <div class="my-4 hstack gap-3">
                                                <button type="submit"
                                                        class="btn btn-primary">{{ __('system.crud.save') }}</button>
                                                <div class="vr"></div>
